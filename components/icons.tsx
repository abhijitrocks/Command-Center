...
export const EyeIcon = createIcon(
  <path fillRule="evenodd" d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" clipRule="evenodd" /><path d="M10 3.5a9.44 9.44 0 00-7.394 3.968C1.83 8.356 1 9.22 1 10s.83 1.644 1.606 2.532A9.44 9.44 0 0010 16.5a9.44 9.44 0 007.394-3.968C18.17 11.644 19 10.78 19 10s-.83-1.644-1.606-2.532A9.44 9.44 0 0010 3.5zM2.5 10a8.033 8.033 0 0115 0 8.033 8.033 0 01-15 0z" />
);

export const HandThumbUpIcon = createIcon(
  <path d="M13.5 6.475c0-.622.503-1.125 1.125-1.125h2.25c.622 0 1.125.503 1.125 1.125v4.5A2.25 2.25 0 0115.75 13.5h-2.25a2.25 2.25 0 01-2.25-2.25v-4.75zM4.875 12.375a2.625 2.625 0 100-5.25 2.625 2.625 0 000 5.25z" /><path fillRule="evenodd" d="M11.625 3.375a2.625 2.625 0 00-2.625 2.625v.875c0 .341-.106.666-.29.938C8.528 7.55 7.886 7.5 7.125 7.5c-.778 0-1.43.053-1.612.088a.75.75 0 00-.563.708v7.954a.75.75 0 00.75.75h.375c.162 0 .317-.03.46-.086.136-.053.256-.13.35-.226l.115-.115c.133-.133.228-.293.278-.465.053-.18.066-.368.036-.552l-.24-1.439c.14-.07.288-.13.44-.175.148-.045.3-.075.45-.091.2-.022.4-.031.6-.031h1.125c.414 0 .807-.123 1.125-.348.318-.225.563-.538.682-.91l.369-1.106c.1-.3.15-.615.15-.938v-.625a2.625 2.625 0 00-2.625-2.625z" clipRule="evenodd" />
);

export const ShareIcon = createIcon(
  <path fillRule="evenodd" d="M15.04 10.23a.75.75 0 00-1.06 0l-5.22 5.22a.75.75 0 001.06 1.06l5.22-5.22a.75.75 0 000-1.06z" clipRule="evenodd" /><path fillRule="evenodd" d="M12.25 5a.75.75 0 000 1.5h1.163l-4.72 4.72a.75.75 0 101.06 1.06l4.72-4.72v1.164a.75.75 0 001.5 0v-2.5a.75.75 0 00-.75-.75h-2.5zM4.75 5A2.25 2.25 0 002.5 7.25v7.5A2.25 2.25 0 004.75 17h7.5A2.25 2.25 0 0014.5 14.75v-2a.75.75 0 00-1.5 0v2A.75.75 0 0112.25 15.5h-7.5A.75.75 0 014 14.75v-7.5A.75.75 0 014.75 6.5h2a.75.75 0 000-1.5h-2z" clipRule="evenodd" />
);
