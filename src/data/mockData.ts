    ...
    return [
      {
        ...
        changeType: 'increase',
        sparkline: generateSparkline(12, 100000 * factor),
        status: 'green',
      ...
      },
      {
        ...
        changeType: 'increase',
        sparkline: generateSparkline(12, 5000 * factor),
        status: 'green',
...
export const getBatchJobSummary = (subscribers: Subscriber[] = [], zones: Zone[] = [], timeRange: TimeRange): BatchJobSummary => {
    ...
    return {
        ...
        filesProcessed: Math.round(41700 * factor),
        filesProcessedChange: `+${(5.8 * filterFactor).toFixed(1)}%`,
    }
};
